      ...
      <footer className="bg-gray-800 text-white py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
            <div>
              <h3 className="text-base font-bold mb-1">SocialConnect</h3>
            ...
            <div>
              <h4 className="font-semibold mb-1 text-sm">Company</h4>
            ...
            <div>
              <h4 className="font-semibold mb-1 text-sm">Resources</h4>
              <ul className="space-y-0.5">
            ...
            <div>
              <h4 className="font-semibold mb-1 text-sm">Legal</h4>
              <ul className="space-y-0.5">
          ...
          <div className="border-t border-gray-700 mt-3 pt-3 flex flex-col md:flex-row justify-between items-center text-xs">
            <p className="text-gray-400">© 2025 SocialConnect. All rights reserved.</p>
